...
const videos = [
  { src: "video/travel.mp4", poster: "img/travel-img.png", title: "세 도시 여행 필름", description: "서울, 광주, 울산의 여행지를 한 번에 만나보세요." },
  { src: "video/seoul1.mp4", poster: "img/seoul1.jpg", title: "서울 여행 필름", description: "도시의 오래된 시간과 새로운 활기를 느껴보세요." },
  { src: "video/gwangju1.mp4", poster: "img/gwangju1.jpg", title: "광주 여행 필름", description: "예술과 여유가 흐르는 광주의 순간을 담았습니다." },
  { src: "video/ulsan1.mp4", poster: "img/ulsan1.jpg", title: "울산 여행 필름", description: "바다와 자연의 에너지를 영상으로 만나보세요." }
];
let videoIndex = 0;
