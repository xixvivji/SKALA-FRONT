...
| 구분 | 프로젝트 | 설명 | 바로가기 |
| --- | --- | --- | --- |
| Assignment | 여행의 발견 | 국내 여행지를 소개하고 여행 일정을 관리하는 웹사이트 | [`assignment/day1/index.html`](assignment/day1/index.html) |
| Practice | Profile Portfolio | 프로필, 프로젝트 경험 및 개발 활동을 소개하는 개인 포트폴리오 | [배포 사이트](https://d3j0t61n2e0cz0.cloudfront.net/) |
...
> 게임 랭킹과 방명록 등 Supabase 연동 기능은 네트워크 연결 및 프로젝트 설정이 필요합니다.
